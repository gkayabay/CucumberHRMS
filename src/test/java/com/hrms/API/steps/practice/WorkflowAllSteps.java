...
public class WorkflowAllSteps {
	...
	Response response;
	static String employeeID; // will use this in same class so static
	...
	public void the_employee_is_created_and_response_contains_key_and_value(String key, String value) {
		response.then().assertThat().body(key, equalTo(value)); // we import static hamcrest
	...
	public void the_retrieved_data_matches_the_data_used_to_create_an_employee(DataTable dataTable) {
		...
		for (Map<String, String> map : expectedData) {
			...
			for (String key : keys) {
				...
				// looping through the response body output and comparing it to our scenario in
				// feature file
